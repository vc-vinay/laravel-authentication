    ...
    export default {
        ...
        methods: {
            ...
            prepareComponent() {
                ...
                var modelCreateClient = document.getElementById('modal-create-client')
                var modelClientName = document.getElementById('create-client-name')

                modelCreateClient.addEventListener('shown.bs.modal', function () {
                    modelClientName.focus();
                });

                var modelEditClientLis = document.getElementById('modal-edit-client')
                var editClientName = document.getElementById('edit-client-name')
                
                modelEditClientLis.addEventListener('shown.bs.modal', function () {
            ...
            showCreateClientForm() {
                ...
                let modelcreateClient = new Modal(document.getElementById('modal-create-client'));
                modelcreateClient.show();
            },
            ...
            edit(client) {
                ...
                let modelEditClient = new Modal(document.getElementById('modal-edit-client'));
                modelEditClient.show();
            },
            ...
            persistClient(method, uri, form, modal) {
                ...
                axios[method](uri, form)
                    .then(response => {
                        ...
                        // $(modal).modal('hide');
                        let modelEditClientP = new Modal(document.getElementById('modal-create-client'));
                        modelEditClientP.hide();
            ...
            showClientSecret(clientSecret) {
                ...
                let modelClientSecret = new Modal(document.getElementById('modal-client-secret'));
                modelClientSecret.show();
            },
